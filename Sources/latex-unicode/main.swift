...
//
//   latex-unicode '\int_5^6'      convert one fragment
//   latex-unicode                 interactive, one fragment per line
//   echo '\alpha' | latex-unicode read fragments from a pipe
//
...
let usage = """
usage: latex-unicode [-c|--codepoints] [fragment ...]
